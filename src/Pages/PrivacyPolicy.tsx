        ...
        <ul>
          ...
          <li>
            <p>
              ...
              "We", "Us" or "Our" in this Agreement) refers to [___COMPANY
              INFORMATION___]
            </p>
            <p>
          ...
          <li>
            <p>
              ...
              (1) every individual who is in the USA for other than a temporary
              or transitory purpose, and (2) every individual who is domiciled
              in the USA who is outside the USA for a temporary or transitory
              purpose.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong>"Website"</strong> refers to [___WEBSITE NAME___],
